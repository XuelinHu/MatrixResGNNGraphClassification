...
backbones rather than recent graph transformers or local-global hybrids, which
is a deliberate control choice but means the study is not a state-of-the-art
comparison. The sensitivity scan is fold-0 only, and the candidate reruns cover
...
larger datasets, richer readouts, and learned residual-neighborhood policies
that replace the hand-specified stencils.
