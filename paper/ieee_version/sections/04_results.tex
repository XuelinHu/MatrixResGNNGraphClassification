...
ENZYMES should be read cautiously: excluding it leaves MatrixRes with 9 wins
over 20 combinations and a mean rank of 2.05, so the aggregate preference is
unchanged.
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.90\columnwidth]{figures/exp/fig_main_benchmark_gcnconv.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.90\columnwidth]{figures/exp/fig_synthetic_multiclass_scaling.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.90\columnwidth]{figures/exp/fig_branch_count_ablation.pdf}
